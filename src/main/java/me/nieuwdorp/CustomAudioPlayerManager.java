...
public class CustomAudioPlayerManager extends DefaultAudioPlayerManager {
     ...
     */
    public CustomAudioPlayerManager() {
...
//                input.readBoolean(), version >= 2 ? DataFormatTools.readNullableText(input) : null);
        AudioTrackInfo trackInfo = new AudioTrackInfo("meh", "meh", 1, "", true, "");
